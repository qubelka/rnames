...
import { addName, initMapvalues, updateName, mapId } from './store/map/actions'
import { addRef, updateRef } from './store/references/actions'
import { addRel, updateRel } from './store/relations/actions'
import { addSname, updateSname } from './store/snames/actions'
