...
urlpatterns = [
    ...
    path('rnames/help/database-structure', views.help_database_structure, name='help-database-structure'),
    path('rnames/help/instruction', views.help_instruction, name='help-instruction'),
    path('rnames/help/structure-of-binning-algorithm', views.help_structure_of_binning_algorithm, name='help-structure-of-binning-algorithm'),
