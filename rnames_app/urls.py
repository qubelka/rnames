...
urlpatterns = [
    ...
    path('rnames/binning/schemes', views.binning_scheme_list, name='binning-scheme-list'),
    ...
    path('rnames/export/csv/binnings', views.export_csv_binnings, name='export-csv-binnings'),
    path('rnames/export/csv/references', views.export_csv_references, name='export-csv-references'),
    ...
    path('rnames/ref_sn/new/<int:reference>/', views.reference_structured_name_new, name='reference-structured_name-new'),
    path('rnames/ref_rel/new/<int:name_one>/<int:reference>/', views.reference_relation_new, name='reference-relation-new'),
...
#    path('rnames/ref_rel/new/<int:reference>/', views.reference_relation_new, name='reference-relation-new'),
    path('rnames/ref_rel/<int:pk>/delete/', views.reference_relation_delete.as_view(), name='reference-relation-delete'),
    ...
    path('rnames/relation/<int:name_one>/<int:name_two>/', views.relation_sql_detail, name='relation_sql-detail'),
    ...
    path('rnames/structured_name/select', views.structuredname_select, name='structuredname-select'),
]
